...
\begin{itemize}
\item działanie algorytmu, czyli  szukanie najmniejszej odległości, aktualizacja ścieżek, jego inicjalizacja, zapis odległości i ścieżek do pliku,
...
\begin{itemize}
\item \verb\VertexData\ reprezentująca poszczególny wierzchołek, jego indeks w macierzy sąsiedztwa oraz koszt dotarcia do niego,
